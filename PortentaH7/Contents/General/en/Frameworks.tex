...
\chapter{Frameworks and Libraries}\index{Frameworks}\index{\TRANS{Bibiotheken}{Libraries}}
...
\subsection{TensorFlow}\index{TensorFlow}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\linewidth]{Nano33BLESense/HandLandmarks}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.5\linewidth]{Nano33BLESense/FaceDetection}
